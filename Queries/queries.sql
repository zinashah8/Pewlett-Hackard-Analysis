...
-- Join dept_emp and new retirement_info
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
de.to_date
...
-- Skill Drill Create a query that returns the info relevant to the Sales Team
...
-- Skill Drill Create a query that returns the following info for the Sales & Development Teams
